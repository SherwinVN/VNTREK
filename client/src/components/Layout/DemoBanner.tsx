...
const texts: Record<string, DemoTexts> = {
  de: {
    ...
    titleAfter: '',
    title: 'Willkommen zur VNTrek Demo',
  ...
  en: {
    ...
    titleAfter: '',
    title: 'Welcome to the VNTrek Demo',
  ...
  es: {
    ...
    titleAfter: '',
    title: 'Bienvenido a la demo de VNTrek',
  ...
  ar: {
    ...
    titleAfter: '',
    title: 'مرحبًا بك في النسخة التجريبية من VNTrek',
  ...
  id: {
    ...
    titleAfter: '',
    title: 'Selamat datang di Demo VNTrek',
  ...
  vi: {
    titleBefore: 'Chào mừng đến với ',
    titleAfter: '',
    title: 'Chào mừng đến với bản Demo VNTrek',
    description: 'Bạn có thể xem, chỉnh sửa và tạo chuyến đi mới. Tất cả các thay đổi sẽ tự động được reset lại sau mỗi giờ.',
    resetIn: 'Reset tiếp theo sau',
    minutes: 'phút',
    uploadNote: 'Chức năng tải tệp lên (ảnh, tài liệu, ảnh bìa) bị tắt ở chế độ demo.',
    fullVersionTitle: 'Ngoài ra phiên bản chính thức còn hỗ trợ:',
    features: [
      'Tải lên tệp (hình ảnh, tài liệu, ảnh bìa)',
      'Quản lý API Key (Google Maps, Thời tiết)',
      'Quản lý thành viên & phân quyền',
      'Tự động sao lưu dữ liệu',
      'Quản lý Addon (bật/tắt linh hoạt)',
      'Đăng nhập một lần OIDC / SSO',
    ],
    addonsTitle: 'Các Addon mô-đun (có thể tắt trong bản chính thức)',
    addons: [
      ['Vacay', 'Lập kế hoạch kỳ nghỉ với lịch trình, ngày lễ & liên kết thành viên'],
      ['Atlas', 'Bản đồ thế giới với các quốc gia đã ghé thăm & thống kê du lịch'],
      ['Hành lý', 'Danh sách kiểm tra đồ đạc cần chuẩn bị cho mỗi chuyến đi'],
      ['Chi tiêu', 'Theo dõi chi phí và chia sẻ hóa đơn nhóm'],
      ['Tài liệu', 'Đính kèm tập tin trực tiếp vào chuyến đi'],
      ['Widgets', 'Chuyển đổi tiền tệ & múi giờ địa phương'],
    ],
    whatIs: 'VNTrek là gì?',
    whatIsDesc: 'Ứng dụng tự lưu trữ (self-hosted) giúp quản lý và lên kế hoạch du lịch với tính năng cộng tác thời gian thực, bản đồ tương tác, đăng nhập bảo mật OIDC và chế độ tối.',
    selfHost: 'Mã nguồn mở — ',
    selfHostLink: 'tự chạy máy chủ',
    close: 'Đã hiểu',
  },
}
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
          ...
          <h2 style={{ margin: 0, fontSize: 17, fontWeight: 700, color: '#111827', display: 'flex', alignItems: 'center', gap: 5 }}>
            {t.titleBefore}<img src="/text-dark.svg" alt="VNTrek" style={{ height: 18 }} />{t.titleAfter}
          </h2>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 11, color: '#9ca3af' }}>
            ...
            <a href="https://github.com/SherwinVN/VNTREK" target="_blank" rel="noopener noreferrer"
